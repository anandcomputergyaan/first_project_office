...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="panel panel-info">
      <div class="panel-heading">Form <a href="<?php echo base_url("/admin/slider/experiences/slider_list")?>" class="pull-right" >Back</a> </div>
        ...
        <div  class="row" >
          ...
          <div class="col-md-8">
            ...
            <tr> <td><b>Slider Image* : </b></td><td> 
                    <img src="<?php echo base_url('uploads/slider/experiences/'.$data['slider_image']);?>" class="img img-lg">

  ...
  <section class="content">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Experiences Slider</li>
      </ol>
    </section>
    
    <!-- /.row (main row) -->
    <div class="panel panel-info">
      <div class="panel-heading">List <a href="<?php echo base_url("/admin/slider/experiences")?>" class="pull-right" >Add</a> </div>
          ...
          <div class="col-md-12">
            ...
            <table class="table table-hover table-bordered">
              ...
              foreach($data as $row) { $id = $row['id']; ?> <tr>
                ...
                <td><img src="<?php echo base_url('uploads/slider/experiences/'.$row['slider_image']);?>" class="img img-lg"></td>
                <td> <?php echo $row['slider_alt']; ?> </td>
                <td> <?php echo $row['image_title']; ?> </td>
     
                
                <td><a href="<?php echo base_url("admin/slider/experiences/slider_edit/".$row['id']);?>">
                  <button title="Edit" class="btn btn-success  btn-sm"><span class="fa fa-edit"></span></button></a>
                  <a href="<?php echo base_url("admin/slider/experiences/delete/".$row['id']); ?>">

          ...
          <div class="col-md-9">
            <form action="../special_tour_update" method="post"  id="form_id" >
              ...
              <table class="table responsive form-group">
                <tr>
                  <td><b> Title<span class="star">*</span>:</b></td><td><input type="text" value="<?php echo $info['title'];?>" name="title" required  class="form-control" placeholder=" Enter Title">
                    <span id="show"></span>
                   </td>
                </tr>
            
            <tr>
              <td><b>Description<span class="star">*</span>:</b></td><td>  <textarea  name="description" required class="form-control ckeditor" placeholder="Enter Description" >   <?php echo $info['title'];?></textarea>  </td>
            </tr>
